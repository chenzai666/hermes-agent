...
class PlatformConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PlatformConfig":
        ...
        # Bridge a top-level `key:` into `extra["key"]` so platforms that
        # read from extra (notably api_server) accept either layout:
        #   platforms:
        #     api_server:
        #       key: "..."           # works via this bridge
        # or
        #     api_server:
        #       extra:
        #         key: "..."         # works directly
        ...
        if _typing is None:
            _typing = _extra.get("typing_indicator")
        ...
        if _typing_text is None:
            _typing_text = _extra.get("typing_status_text")
